...
#line 148 "intcodeasm.tab.cc"
    ...
    : super_type (YY_MOVE (that.state), YY_MOVE (that.location))
  {
    ...
    {
      case 7: // "integer"
        value.YY_MOVE_OR_COPY< intmax_t > (YY_MOVE (that.value));
        break;
    ...
    : super_type (s, YY_MOVE (that.location))
  {
    ...
    {
      case 7: // "integer"
        value.move< intmax_t > (YY_MOVE (that.value));
        break;
  ...
  parser::stack_symbol_type::operator= (stack_symbol_type& that)
  {
    ...
    {
      case 7: // "integer"
        value.move< intmax_t > (that.value);
        break;
...
#undef YYCASE_
  ...
  {
  "$end", "error", "$undefined", "\"mnemonic\"", "\"identifier\"",
  "\"BP\"", "\"DI\"", "\"integer\"", "\"end-of-line\"", "':'", "'+'",
  "'-'", "'['", "']'", "','", "$accept", "program", "label_definition",
  "optional_label", "argument_expression", "bp_modifier",
  "relative_argument", "absolute_argument", "immediate_argument",
  "argument", "labeled_argument", "argument_list", "instruction",
  "optional_instruction", "instruction_statement", "di_statement",
