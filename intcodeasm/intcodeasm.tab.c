...
#ifndef YY_YY_INTCODEASM_TAB_H_INCLUDED
# define YY_YY_INTCODEASM_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_INTCODEASM_TAB_H_INCLUDED  */
...
{
  "$end", "error", "$undefined", "MNEMONIC", "IDENTIFIER", "BP", "DI",
  "INTEGER", "EOL", "':'", "'+'", "'-'", "'['", "']'", "','", "$accept",
  "program", "label_definition", "optional_label", "argument_expression",
  "bp_modifier", "relative_argument", "absolute_argument",
  "immediate_argument", "argument", "labeled_argument", "argument_list",
  "instruction", "optional_instruction", "instruction_statement",
  "di_statement", "statement", YY_NULLPTR
};
#endif
...
{
     -17,   -17,     7,   -17,   -16,   -17,   -17,   -17,   -17,    12,
     -17,   -11,   -17,   -17,   -17,   -17,    24
};
